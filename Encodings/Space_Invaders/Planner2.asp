...
distance_left_column(X,T) :- not invaders_near_player(T), player(X1,_,T), most_left_invader(X2,T), X1>=X2, X=X1-X2,validValue(X1),validValue(X2).
distance_left_column(X,T) :- not invaders_near_player(T), player(X1,_,T), most_left_invader(X2,T), X1<X2, X=X2-X1,validValue(X1),validValue(X2).
...
distance_player_invader(X,T) :- invaders_near_player(T), player(X1,_,T), nearest_y_invader(X2,_,T), X1>=X2, X=X1-X2,validValue(X1),validValue(X2).
distance_player_invader(X,T) :- invaders_near_player(T), player(X1,_,T), nearest_y_invader(X2,_,T), X1<X2, X=X2-X1,validValue(X1),validValue(X2).
